...
# Split le message en n fragment de 36 Bytes. valeur 36 marche avec le packet 'template', possiblement à cause de la taille défini dans celui-ci.
frag_len=36
...
for i, fragment in enumerate(fragments):
    ...
    if i != len(fragments) - 1:
        ...
        fragment += b'\0' * (frag_len - len(fragment)) # Padding de zero jusqu'à frag_len
        packet.FCfield &= ~0x4
